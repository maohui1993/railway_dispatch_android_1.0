...
public class WorkControllerCenterFragment extends BaseFragment implements WorkControllerCenterContract.View {
    private WorkControllerCenterContract.Presenter mPresenter;
    ...
    protected void prepare() {
        mPresenter = new WorkControllerCenterPresenter(getContext(), this);
    }
