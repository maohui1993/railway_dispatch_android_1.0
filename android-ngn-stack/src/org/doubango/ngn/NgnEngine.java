...
public class NgnEngine {
	 ...
	 */
	public Class<? extends Service> getNativeServiceClass(){
		return mNativeServiceClass;
	}

	private Class<? extends Service> mNativeServiceClass = NgnNativeService.class;

	public void setNativeServiceClass(Class<? extends Service> clazz) {
		mNativeServiceClass = clazz;
	}
}
