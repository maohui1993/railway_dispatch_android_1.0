...
public class EnDeUtil {
    ...
    public static final String Salt = "dazhou01";//密钥
    public static final String PWD="2105";//
    /**
     * 定义迭代次数为1000次
     */
    ...
    public  static  String getCrc32Str(byte[] bytes)
    {
        ...
        resultCrcValue = resultCrcValue ^ 0x00000000ffffffffL;
        return Long.toHexString(resultCrcValue).toUpperCase()  ;
    }
